...
class ChatGPTDriver:
    ...
    def data_cleaning(self, message: str):
        prompt = """Clean all superfluous data from message like Note summarizing etc if exists, just leave 2 twitter posts in format 
        1. *Top Bullish Post*:
                <author X handle>, <month date>, <time>:
                <"post text">
        2. *Top FUD / Negative Post*:
