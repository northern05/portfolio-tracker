...
top_1_bullish = 'Process data, and choose TOP 1 Bullish post based on post data provided for specified %s. #Output only in JSON format: {"twitter_id": <>, "twitter_user_id": <>}. #DONT ADD TEXT.'
top_1_fud = 'Process data, and choose TOP 1 Bearish/FUD post based on post data provided for specified %s. #Output only in JSON format: {"twitter_id": <>, "twitter_user_id": <>}. #DONT ADD TEXT.'