...
def get_top_posts(token: str, time_window: PostsTimeWindow = PostsTimeWindow.HOUR, page: int = 1, page_size: int = 10):
    from app import config
    url = f'{ELFA_URL}/top-mentions?ticker={token}&timeWindow={time_window.value}&page={page}&pageSize={page_size}'
    headers = {
